...
* imageop.h - Модуль с общими структурами пикселя и изображения
* transrot.h - Модуль с функцией вращения изображения. Для дальнейшего расширения в модуле содержаться перечисления с направлением поворота и с углом поворота. На данный момент в пречислениях по одному объекту - вращение влево и угол 90 градусов
* bmpdesc.h - Модуль чтения/записи изображений с расширением BMP
* util.h - Модуль с дополнительными функциями - открытие/закрытие файла и отслеживание статуса операций с файлом. В случае возникновения ошибки вызывается функция вывода ошибки в stderr и закрытие программы, иначе вывод сообщения об успешном завершении операции в stderr

# Реузльтаты работы программы

Результаты прохождения тестов и вывода программы представлены на рисунке 1

| ![Результат(./img/Result.png) |
|:--:|
| <b>Рисунок 1. Результаты тестов и вывод программы</b> |

Исходное изображение представлено на рисунке 2

| ![Вход](./img/input.bmp) |
|:--:|
| <b>Рисунок 2. исходное изображение</b> |

Итоговое изображение представлено на рисунке 3

| ![Выход](./img/output.bmp) |
|:--:|
| <b>Рисунок 3. Итоговое изображение</b> |
